...
module InsightlySwagger
  ...
  class APIOpportunityState
    ...
    attr_accessor :date_changed_utc
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'DATE_CHANGED_UTC']
        self.date_changed_utc = attributes[:'DATE_CHANGED_UTC']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date_changed_utc == o.date_changed_utc &&
    ...
    def hash
      [opportunity_id, date_changed_utc, for_opportunity_state, state_reason_id, state_reason].hash
    end
