...
module InsightlySwagger
  ...
  class APICustomFieldGroup
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'GROUP_FOR']
        self.group_for = attributes[:'GROUP_FOR']
      end
      
      if attributes[:'GROUP_ORDER']
        self.group_order = attributes[:'GROUP_ORDER']
      end
    ...
    def hash
      [group_id, group_name, group_for, group_order].hash
    end
