...
module InsightlySwagger
  ...
  class APITeamMember
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'MEMBER_USER_ID']
        self.member_user_id = attributes[:'MEMBER_USER_ID']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          team_id == o.team_id &&
          member_user_id == o.member_user_id
    end
    ...
    def hash
      [permission_id, team_id, member_user_id].hash
    end
