...
module InsightlySwagger
  ...
  class APIEventLink
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'EVENT_LINK_ID']
        self.event_link_id = attributes[:'EVENT_LINK_ID']
      end
    ...
    def hash
      [event_link_id, event_id, contact_id, organisation_id, opportunity_id, project_id, lead_id].hash
    end
