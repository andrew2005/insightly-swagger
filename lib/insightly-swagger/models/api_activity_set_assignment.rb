...
module InsightlySwagger
  ...
  class APIActivitySetAssignment
    ...
    attr_accessor :activity_assignments
    ...
    def self.swagger_types
      {
        ...
        :'start_date' => :'DateTime',
        :'end_date' => :'DateTime',
        :'activity_assignments' => :'Array<APIActivityAssignment>'
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'ACTIVITY_ASSIGNMENTS']
        if (value = attributes[:'ACTIVITY_ASSIGNMENTS']).is_a?(Array)
          self.activity_assignments = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          end_date == o.end_date &&
          activity_assignments == o.activity_assignments
    end
    ...
    def hash
      [activityset_id, start_date, end_date, activity_assignments].hash
    end
